...
live state and publishes ownership. An explicit post-response idle hook invokes
recovery and hands the renewed journal to the existing live applet. See
[the renewal transition](STORAGE.md#jcvm-counter-renewal).
