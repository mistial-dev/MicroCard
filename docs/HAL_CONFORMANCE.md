...
- fixed-buffer FIPS 180-4 SHA-256, RFC 4231 HMAC-SHA-256, RFC 4493 AES-CMAC including segmented input, NIST SP 800-38A AES-128 block/CBC, NIST CAVP AES-CCM, RFC 8032 Ed25519 positive and changed-message vectors, and P-256 public-key, deterministic ECDSA and ECDH known answers through the selected crypto provider.
- CBC padding and CCM tag rejection with cleared plaintext, malformed Ed25519 and P-256 verification inputs, invalid P-256 private-scalar failure mapping, invalid ECDH peer rejection and cleared fixed outputs.
