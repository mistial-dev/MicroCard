...
public static class ProtectedCommand {
 [Process] public static void Process(){if(SecureChannel.SecurityLevel!=0x13){ResponseApdu.SetStatus(0x6982);return;}var data=new byte[1];data[0]=0x61;var digest=Cryptography.Sha256(data);ResponseApdu.Write(digest,0,1);}
}
