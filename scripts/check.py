#!/usr/bin/env python3
"""Host validation entry point. Neither mode launches sustained fuzz campaigns."""
...
def check_public_prose():
 files=[ROOT/name for name in ['README.md','CONTRIBUTING.md','SECURITY.md','CHANGELOG.md','THIRD_PARTY_NOTICES.md']]
 ...
 if failures: raise SystemExit('Public prose style check failed:\n  '+'\n  '.join(failures))
def main():
 p=argparse.ArgumentParser(description=__doc__)
 p.add_argument('--checkpoint',action='store_true',help='run exhaustive host and recovery acceptance, excluding sustained fuzzing')
 a=p.parse_args()
 check_public_prose()
 ...
 run('python3','scripts/generate_jcvm_api.py','--check')
 ...
 if not a.checkpoint:
  ...
  for project in ['managed/MicroCard.Analyzers','managed/MicroCard.Tool','managed/MicroCard.Pack','managed/MicroCard.Bundle','managed/MicroCard.Iso7816','managed/MicroCard.Encoding','managed/MicroCard.Cryptography','managed/MicroCard.Security','samples/CoreLib','samples/CoreConsumer','samples/Counter','samples/TransactionRecords','samples/CryptographyConsumer','samples/SecurityConsumer','samples/Credential','tests/CoreReference','tests/Iso7816Reference','tests/EncodingReference','tests/CryptographyReference']:
   run('dotnet','build',project,'-c','Release','--nologo','--verbosity','quiet','-p:NuGetAudit=false')
  ...
  print('PASS: quick Rust, managed-tool and schema validation')
  return
 ...
 for symbol,diagnostic in [('CASE_LANGUAGE','MCA0001'),('CASE_ASYNC_METHOD','MCA0001'),('CASE_USING_DECLARATION','MCA0001'),('CASE_TYPEOF','MCA0001'),('CASE_INIT_PROPERTY','MCA0001'),('CASE_TYPE','MCA0002'),('CASE_REF_RETURN','MCA0003'),('CASE_SHAPE','MCA0003'),('CASE_STATIC_CONSTRUCTOR','MCA0003'),('CASE_INTERFACE','MCA0003'),('CASE_NESTED_TYPE','MCA0003'),('CASE_STATIC_FIELD','MCA0003'),('CASE_FIELD_TYPE','MCA0003'),('CASE_METHOD_IMPL_FLAGS','MCA0003'),('CASE_INHERITANCE','MCA0003'),('CASE_LITERAL_FIELD_TYPE','MCA0003'),('CASE_EVENT','MCA0003'),('CASE_STATIC_AUTO_PROPERTY','MCA0003'),('CASE_AUTO_PROPERTY_FIELD','MCA0003'),('CASE_EXTERNAL','MCA0004'),('CASE_SYSTEM_SHA256_OVERLOAD','MCA0004'),('CASE_SYSTEM_RNG_OVERLOAD','MCA0004'),('CASE_LIFECYCLE','MCA0005'),('CASE_EXPORT','MCA0006'),('CASE_DEPENDENCY','MCA0007'),('CASE_REFERENCE_ALIAS','MCA0007'),('CASE_REFERENCE_RESERVED','MCA0007'),('CASE_DEVICE_IDENTITY','MCA0007'),('CASE_IDENTIFIER','MCA0007'),('CASE_TRANSACTION','MCA0008'),('CASE_EXPLICIT_TRANSACTION','MCA0008'),('CASE_TRANSACTION_CONSTRUCTOR','MCA0008'),('CASE_CALL_GRAPH','MCA0009'),('CASE_CALL_DEPTH','MCA0009'),('CASE_LOCALS','MCA0010'),('CASE_ALLOCATION','MCA0011'),('CASE_ALLOCATION_OVERHEAD','MCA0011'),('CASE_LOOP_ALLOCATION','MCA0012'),('CASE_LOOP_OBJECT_ALLOCATION','MCA0012'),('CASE_LOOP_COLLECTION_ALLOCATION','MCA0012'),('CASE_AGGREGATE_ALLOCATION','MCA0013'),('CASE_CALL_ALLOCATION','MCA0014'),('CASE_SWITCH_LIMIT','MCA0015'),('CASE_CALL_OBJECTS','MCA0016'),('CASE_PARAMETERS','MCA0017'),('CASE_DEPENDENCY_LIMIT','MCA0018'),('CASE_ENTRY_LIMIT','MCA0019'),('CASE_METHOD_ROWS_LIMIT','MCA0020'),('CASE_TYPE_ROWS_LIMIT','MCA0021'),('CASE_FIELD_ROWS_LIMIT','MCA0022'),('CASE_ATTRIBUTE_ROWS_LIMIT','MCA0023'),('CASE_STORAGE_SCHEMA','MCA0024'),('CASE_STORAGE_ACCESS','MCA0025')]:
  bad=subprocess.run(['dotnet','build','tests/AnalyzerCases','-c','Release','-t:Rebuild','--nologo','--verbosity','quiet',f'-p:MicroCardAnalyzerCase={symbol}'],cwd=ROOT,capture_output=True,text=True)
  assert bad.returncode!=0 and diagnostic in bad.stdout,(symbol,bad.stdout,bad.stderr)
 run('dotnet','build','tests/AnalyzerCases','-c','Release','-t:Rebuild','--nologo','--verbosity','quiet','-p:MicroCardAnalyzerCase=CASE_ALLOCATION_BOUNDARY')
 run('dotnet','build','tests/AnalyzerCases','-c','Release','-t:Rebuild','--nologo','--verbosity','quiet','-p:MicroCardAnalyzerCase=CASE_SWITCH_BOUNDARY')
 run('dotnet','build','tests/AnalyzerCases','-c','Release','-t:Rebuild','--nologo','--verbosity','quiet','-p:MicroCardAnalyzerCase=CASE_PARAMETERS_BOUNDARY')
 run('dotnet','build','tests/AnalyzerCases','-c','Release','-t:Rebuild','--nologo','--verbosity','quiet','-p:MicroCardAnalyzerCase=CASE_DEPENDENCY_BOUNDARY')
 run('dotnet','build','tests/AnalyzerCases','-c','Release','-t:Rebuild','--nologo','--verbosity','quiet','-p:MicroCardAnalyzerCase=CASE_ENTRY_BOUNDARY')
 run('dotnet','build','tests/AnalyzerCases','-c','Release','-t:Rebuild','--nologo','--verbosity','quiet','-p:MicroCardAnalyzerCase=CASE_METHOD_ROWS_BOUNDARY')
 run('dotnet','build','tests/AnalyzerCases','-c','Release','-t:Rebuild','--nologo','--verbosity','quiet','-p:MicroCardAnalyzerCase=CASE_TYPE_ROWS_BOUNDARY')
 run('dotnet','build','tests/AnalyzerCases','-c','Release','-t:Rebuild','--nologo','--verbosity','quiet','-p:MicroCardAnalyzerCase=CASE_FIELD_ROWS_BOUNDARY')
 run('dotnet','build','tests/AnalyzerCases','-c','Release','-t:Rebuild','--nologo','--verbosity','quiet','-p:MicroCardAnalyzerCase=CASE_ATTRIBUTE_ROWS_BOUNDARY')
